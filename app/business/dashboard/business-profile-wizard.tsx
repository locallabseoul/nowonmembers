  ...
  function validateStep(stepIndex: number) {
    ...
    const requiredByStep = {
      ...
      1: [
        ...
        [draft.contact.trim(), "연락처를 입력해주세요."],
          ...
          <FormCard>
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <TextField
                ...
                label="연락처"
                value={draft.contact}
                onChange={(value) => updateDraftField("contact", value)}
          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
            <FormCard>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <ReviewItem label="연락처" value={draft.contact} />
      ...
      <div className="overflow-hidden rounded-[20px] border border-slate-100 bg-white shadow-sm">
        ...
        <div className="space-y-4 p-5">
          ...
          <div className="grid gap-2 text-sm text-slate-600">
            ...
            <span className="flex items-center gap-2"><Phone size={16} className="text-primary" />{draft.contact || "연락처"}</span>
